...
export default function Challenge() {
  return (
    <div className="grid grid-rows-3 grid-cols-3 grid-flow-col items-center justify-around font-open-sans h-80 w-2/3 mx-auto">
      ...
      <div className="row-span-1 col-span-2 md:text-lg sm:text-base flex flex-col justify-between self-start">
        <div className=" pb-3">Complete a simple Foxit <span className="text-blue-300">Plugin</span> Project and win ______ </div>
        <a href="https://forms.office.com/r/5ZubiwG0TK" target="_blank" rel="noreferrer"
           className="bg-gradient-to-r from-orange-dark to-orange-light w-40 flex justify-center items-center h-10 rounded-md  text-white font-bold motion-reduce:transform-none transform hover:scale-105 duration-300"
        >
          Sign Up Here
        </a>
      ...
      <div className="row-span-1 col-span-3 flex gap-4 justify-around items-center">
        <a href="https://discord.gg/5qkT3qxmV3" target="_blank" rel="noreferrer" className="flex items-start space-x-4">
          <svg fill="#5865f2" className="flex-none text-indigo-400 w-12 h-12 motion-reduce:transform-none transform hover:scale-105 duration-300">
          ...
          <div className="flex-auto"><h3 className="font-bold text-gray-900">Discord</h3><p>Join our Discord community to
            get better support</p></div>
        </a>
        <a href="https://github.com/DanGodfreyjr/FoxitStudentChallenges" target="_blank" rel="noreferrer" className="flex items-start space-x-4">
          <svg fill="currentColor" className="flex-none text-gray-900 w-12 h-12 motion-reduce:transform-none transform hover:scale-105 duration-300">
            <rect width="48" height="48" rx="12"/>
      ...
      <div className="row-span-2 col-span-1 w-40">
