export default function Benefits() {
  return (
    <div className="w-full flex justify-center items-center pb-28">
      <div className="grid grid-cols-2 gap-x-4 gap-y-32 w-1040px">
        <div className="flex justify-center items-center">
          <img src="/SVG/experience.svg" alt="" className="w-96"/>
        </div>
        <div>
    ...
    //     <img src="/SVG/experience.svg" alt="" className="w-96 px-4 lg:mr-20"/>
    //   </div>
    ...
    //     <div className="px-4 flex-col flex justify-start items-start">
    //       <span className="font-bold text-2xl">Real Industry Experience</span>
    //       <span className="font-semibold">in developing creative and robust software</span>
    //     </div>
    //     <div className="text-base text-gray-500 pt-6 w-96 px-4 font-semibold">
    //       Work with engineers from our education team on plug-in projects created to help students and teachers study, organize, and create PDF documents more efficiently. Get feed back from our education team about how to design your program for the education market.
    //     </div>
    //   </div>
    //
