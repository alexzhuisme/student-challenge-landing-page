  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="h-32 px-4 w-full lg:w-2/3 flex flex-col justify-around items-center">
        ...
        <p className="w-10/12">Come up with your own PDF plug in idea and submit it as a Challenge. Get creative and create a feature inspired by your own document needs.</p>
      </div>
