...
export default function Projects() {
  return (
    <div className="w-full flex flex-col justify-center items-center">
      <div className="text-3xl font-bold pb-6 flex justify-center items-center text-center">Pick Your Challenge From These Available Projects</div>
      ...
      <div className="pt-6 text-xl font-bold flex justify-center items-center text-center"><a href="https://github.com/DanGodfreyjr/FoxitStudentChallenges/blob/main/CompletedChallenges.MD" target="_blank" rel="noreferrer" className="hover:underline">Check Out Challenge Projects Completed by Students Like You!</a></div>
    </div>
  )
}