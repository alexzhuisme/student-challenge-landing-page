export default function Banner() {
  return (
    <div className="h-auto w-full flex justify-center my-32">
      <div className="w-1040px text-base text-gray-500 bg-white rounded-3xl flex justify-around items-center py-10">
        <div>
        ...
        <div>
          <a href="https://github.com/DanGodfreyjr/FoxitStudentChallenges" target="_blank" rel="noreferrer" className="flex items-start space-x-4 px-4">
            ...
            <div className="flex-auto">
              ...
              <p>Check our available challenges on GitHub</p></div>
          </a>
        </div>
