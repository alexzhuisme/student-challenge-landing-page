export default function Banner() {
  return (
    <div className="h-auto w-full flex justify-center my-10 xl:my-32 px-4 sm:px-20">
      <div className="w-full xl:w-1040px text-base text-gray-500 bg-white rounded-3xl flex flex-wrap sm:grid sm:grid-cols-2 justify-center md:justify-around items-center py-4 lg:py-10 gap-y-4 px-4">
        <div className="flex justify-center items-center">
          <a href="https://discord.gg/5qkT3qxmV3" target="_blank" rel="noreferrer" className="flex justify-center items-center space-x-4">
            ...
            <div className="flex-auto">
              <div className="font-bold text-gray-900">Discord</div>
              <p>Join our Discord developer community to get realtime support</p>
            </div>
          </a>
        </div>

        <div className="flex justify-center items-center">
          <a href="https://github.com/DanGodfreyjr/FoxitStudentChallenges" target="_blank" rel="noreferrer" className="flex justify-center items-center space-x-4 px-4">
            ...
            <div className="flex-auto">
              ...
              <p>Browse our challenge projects on GitHub to pick one that’s right for you</p></div>
          </a>
        </div>
